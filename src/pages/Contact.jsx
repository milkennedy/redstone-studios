    ...
    <main>
      <section className="relative overflow-hidden px-6 pb-16 pt-40 md:px-10 md:pb-20 md:pt-48">
        ...
        <div className="relative mx-auto max-w-content">
          ...
          <Reveal delay={0.15}>
            <p className="mt-8 max-w-prose text-[1.12rem] leading-relaxed text-cream2">Redstone Studios works with a select number of organizations at any given time. If you are an executive leader serious about AI transformation — not experimentation — we want to hear from you.</p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-content grid-cols-1 gap-px overflow-hidden rounded-sm border border-stone bg-stone lg:grid-cols-2">
          ...
          <Reveal>
            <div className="h-full bg-gradient-to-br from-[#3a281d] to-ink3 p-10 md:p-14">
              ...
              <p className="mb-8 max-w-md text-[1.02rem] leading-relaxed text-muted">A focused 15-minute conversation to understand your situation and whether Redstone is the right fit. No pitch deck, no pressure.</p>
              ...
              <div className="mt-10 space-y-5 border-t border-stone/60 pt-8">
                {[[Clock, <><span className="text-cream2">15 minutes</span> — direct with the founder, Mike Kennedy, PhD.</>], [Mail, <><span className="text-cream2">Prefer email?</span> Use the form and we'll respond within two business days.</>], [MapPin, <><span className="text-cream2">Based in Canada</span> — serving organizations nationwide.</>]].map(([Icon, txt], i) => (
          ...
          <Reveal delay={0.1}>
            <div className="h-full bg-ink3 p-10 md:p-14">
              ...
              <p className="mb-8 text-[0.97rem] text-muted">Tell us a little about your organization and what you're trying to solve.</p>
              {status === 'sent' ? (
